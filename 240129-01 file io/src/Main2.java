...
// 변경의 기록(log)
// 1. 고정된 경로 파일 이름 사용 (설정 파일과 별개의 파일)
// 2. 시간. 색상.
// ex) 2024-01-29 12:58:33 사용자가 색상(233, 211, 201)을 변경함.
// ex) 2024-01-29 12:59:12 사용자가 색상(200, 200, 200)을 변경함.
...
public class Main2 extends JFrame {
	...
	public Main2() {
		...
		Color backgroundColor = configAccessor.readConfig();
